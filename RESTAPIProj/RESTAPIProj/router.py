from RESTAPIApp.viewsets import EmployeeViewset  #import the viewset for routers
from rest_framework import routers #import router to make the urls.
...
router = routers.DefaultRouter()  #setting the instance to default router.
router.register('employee',EmployeeViewset)  #setting the route path.
