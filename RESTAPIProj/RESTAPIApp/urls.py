...
urlpatterns = [
    ...
    path('propertylist/', views.PropertyListing, name='PropertyListing'), #this will show the home page.
    ...
    path('individualprop/', views.IndividualProp, name='IndividualProp'), #This is the API url from where the user will send its API request and get the individual property json data.
]